...
| Variable | Default |
|---|---|
| `--origam-transition--window-x-translate-enter-active---transition-duration` | `0.3s` |
| `--origam-transition--window-x-translate-enter-active---transition-timing-function` | `cubic-bezier(0.25, 0.8, 0.5, 1)` |
| `--origam-transition--window-x-translate-leave-active---transition-duration` | `0.3s` |
| `--origam-transition--window-x-translate-leave-active---transition-timing-function` | `cubic-bezier(0.25, 0.8, 0.5, 1)` |

Override at the document root or on a specific instance:

```css
.my-panel {
    --origam-transition--window-x-translate-enter-active---transition-duration: 0.15s;
}
```
