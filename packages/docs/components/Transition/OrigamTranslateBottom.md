...
| Variable | Default |
|---|---|
| `--origam-transition--translate-bottom-enter-active---transition-duration` | `225ms` |
| `--origam-transition--translate-bottom-enter-active---transition-timing-function` | `var(--origam-motion__easing---decelerate)` |
| `--origam-transition--translate-bottom-leave-active---transition-duration` | `125ms` |
| `--origam-transition--translate-bottom-leave-active---transition-timing-function` | `var(--origam-motion__easing---accelerate)` |

Override at the document root or on a specific instance:

```css
.my-panel {
    --origam-transition--translate-bottom-enter-active---transition-duration: 0.15s;
}
```
