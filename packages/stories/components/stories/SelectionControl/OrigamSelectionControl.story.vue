<template>
  ...
  >
    ...
    <Variant
      title="Design"
      :init-state="() => useStoryInitState<Partial<ISelectionControlProps>>({ label: 'Control label', color: 'primary', bgColor: undefined, density: undefined, trueIcon: MDI_ICONS.CHECKBOX_MARKED_OUTLINED, falseIcon: MDI_ICONS.CHECKBOX_BLANK_OUTLINED, inline: false, rounded: undefined, elevation: undefined, border: undefined, borderColor: undefined, borderStyle: undefined })"
    >
    ...
    <Variant
      title="Default"
      :init-state="() => useStoryInitState<ISelectionControlProps>({ label: 'Control label', type: 'checkbox', color: 'primary', density: undefined, trueIcon: MDI_ICONS.CHECKBOX_MARKED_OUTLINE, falseIcon: MDI_ICONS.CHECKBOX_BLANK_OUTLINE, disabled: false, readonly: false, required: false })"
    >
      <template #default="{ state }">
